            ...
            <div class="row">
                <div class="col-12">
                    <nav class="breadcrumb bg-transparent">
                        ...
                        <span class="breadcrumb-item">Shop Detail</span>
                    </nav>
                    <h1 class="text-center">Celling Fan</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @if(!empty($gallery[0]))
                                @foreach($gallery as $key => $img)
                                    <a href="{{ asset('public/images/product/'.$img) }}">
                                        <img class="xzoom-gallery " width="80" src="{{ asset('public/images/product/'.$img) }}">
                                    </a>
                                @endforeach
                            @endif
                        </div>
...
{{--                            <p><b>Warrenty:</b> 1 Year</p>--}}
                        ...
                        @else
                            {!! Form::hidden('price', 0) !!}
                        @endif
                        <h4>Price: <del>Tk {{ $product->regular_price ?? 'N/A' }}</del> <span class="text-danger">Tk {{ $product->sales_price ?? 'N/A' }}</span> </h4>
...
{{--                                </div>--}}
                        ...
                        <div class="d-flex pt-2">
                            @php
                                ...
                                //echo intval($hour);
                            @endphp
                           <i class="fa fa-fire text-danger"></i>  {{ rand(1,10) }} sold in last {{ intval($hour) }} hours
                        </div>
                    </div>
                </div>
...
{{--                                    <img class="img-fluid" src="{{ asset('public/images/product') }}/{{ $similar_product->thumb }}" alt="">--}}
...
{{--                                        {!! Form::close() !!}--}}
{{--                                        <a class="btn btn-outline-dark btn-square" href="{{ route('product_details', ['id' => $similar_product->slug]) }}"><i class="far fa-eye"></i></a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="productdetails">--}}
{{--                                    <a href="{{ route('product_details', ['id' => $similar_product->slug]) }}">{!! Str::limit($similar_product->title, 32, '..') !!}</a>--}}
{{--                                    <p><del>Tk {{ $similar_product->regular_price ?? 'N/A' }}</del> Tk {{ $similar_product->sales_price ?? 'N/A' }} </p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        @endforeach--}}
