            ...
            <div class="row">
                <div class="col-12">
                    <nav class="breadcrumb bg-transparent">
                        ...
                        <a class="breadcrumb-item" href="#">Product <i class="fa fa-angle-right"></i></a>
            ...
            <div class="row">
                @php
                    ...
                    if (empty($brand)){
                        ...
                        $brands=\App\Models\Product::groupBy('brand_id')->select('brand_id')->where('category_id',$category->id)->where('brand_id','=',$brand->id)->get();
                    }
                        ...
                        <div class="sidebar">
                            ...
                            <ul>
                                @foreach($brands as $brand)
                                    <li>
                                        <label>
                                            <input type="checkbox" checked class="sort_rang brand" id="brand" name="brand[]" value="{{ $brand->brand->id }}"> {{ $brand->brand->title ?? 'N/A' }}
                                        </label>
                                    </li>
                                @endforeach
