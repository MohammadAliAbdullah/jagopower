						...
						<div class="product-area">
							...
							<div class="form-group row">
								<div class="col-sm-6">
									...
									{!! Form::select('city', ['0'=>'Select District']+$districts,null,['class'=>'form-control','id'=>'district','required']); !!}
								</div>
								<div class="col-sm-6">
							...
							<div class="form-group row">
								<div class="col-sm-12">
                                    ...
                                    <label>
                                        <input id='watch-me' name='payment_method' value="cash_on_delivery" type='radio' checked />Check On Delivary
                                    </label><br>
{{--													{!! Form::radio('payment_method', 'cash_on_delivery', true); !!} Check On Delivary <br>--}}
									<img src="{{ asset('public/images/') }}/sslcommerz.jpg" class="img-fluid" width="60"> <label>{!! Form::radio('payment_method', 'ssl'); !!} Online Payment</label><br>
...
{{--													@foreach($payments as $payment)--}}
									...
									<div id='show-me-two' style="display: none">
										দয়া করে আমাদের এই 01976223330 বিকাশ মার্চেন্ট নম্বর এ {{ Cart::getSubTotal() }} টাকা পেমেন্ট করুন।
										<div class="row">
											<div class="col-md-6">
												{!! Form::number('bkashnumber', null, ['class'=>'form-control', 'placeholder'=>'Your Bkash Number']) !!}
											</div>
											<div class="col-md-6">
												{!! Form::number('transaction', null, ['class'=>'form-control','placeholder'=>'Transaction No']) !!}
											</div>
										</div>
									</div>
									<div id='show-me-three' style="display: none">
										দয়া করে আমাদের এই 017262233308 রকেট মার্চেন্ট নম্বর এ {{ Cart::getSubTotal() }} টাকা পেমেন্ট করুন।
										<div class="row">
											<div class="col-md-6">
								...
								@foreach($cartCollection as $item)
									<tr class="cart_item">
										...
										<td class="product-total">
											<span class="woocommerce-Price-amount amount">TK.{{$item->getPriceSum()}}</span>
										</td>
									</tr>
								@endforeach
								</tbody>
