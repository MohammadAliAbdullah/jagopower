...
@section('content')
    ...
    <!-- Breadcrumb Start -->
    <div class="breadcrumbbg" style="background: linear-gradient(rgb(8 8 8 / 56%), rgb(40 40 40 / 51%)), url('{{ url('/') }}/public/images/{{ $category->background ?? $category->parent->background ?? '' }}'); background-size: cover;">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="breadcrumb bg-transparent">
                        ...
                        <span class="breadcrumb-item">{{ $category->title ?? 'N/A' }}</span>
                    </nav>
                    <h1 class="text-center">{{ $category->title ?? 'N/A' }}</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="sidebar">
                            ...
                            <ul>
                                @foreach($brands as $brand)
                                    <li>
                                        <label>
                                            <input type="checkbox" class="sort_rang brand" id="brand" name="brand[]" value="{{ $brand->brand->id }}"> {{ $brand->brand->title ?? 'N/A' }}
                                        </label>
                                    </li>
                                @endforeach
{{--                                <button class="btn btn-info">Submit</button>--}}
                        ...
                        <div class="sidebar">
                            ...
                            <ul>
                                @foreach($subcats as $categorie)
                                    <li>
                                        <label>
                                            <input type="checkbox" class="sort_rang category" id="category" name="category[]" value="{{ $categorie->subcategory->id }}"> {{ $categorie->subcategory->title ?? 'N/A' }}
                                        </label>
                                    </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="sidebar" style="height: 100px">
                        ...
                        <ul>
                            ...
                            @foreach($colorr as $color)
                                ...
                                <li style="float: left;">
                                    <label>
                                        <input type="checkbox" class="sort_rang color" id="color" name="color[]" value="{{ $colorrr->id }}" style="display: none;">
                                        <span style="color:{{ $colorrr->value }}; background-color:{{ $colorrr->value }}; box-shadow: 1px 1px 5px black; border-radius: 100%;">⬤ </span>
                                    </label>
                                </li>
                                @endif
                            @endforeach
                    ...
                    <div class="sidebar">
                        ...
                        <ul>
                            ...
                            @foreach($sizer as $sizerr)
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="sort_rang size" id="size" name="size[]" value="{{ $sizerrr->id }}"> {{ $sizerrr->name ?? 'N/A' }}
                                    </label>
                                </li>
                                @endif
                            @endforeach
                    ...
                    <div class="sidebar">
                        ...
                        <ul>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="0-5000"> TK. 5000
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="5001-10000"> TK 5001 - TK10000
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="10001-20000"> TK 10001 - TK 20000
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="20001-50000"> TK 20001- TK 50000
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="50001-100000"> TK 50001 - TK 100000
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="radio" class="sort_rang price" id="price" name="price[]" value="100000-100000"> Up TK 100001
                                </label>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="{{ url('category') }}/{{ $categorr->slug }}">
                                                ...
                                                <img class="media-object img-fluid" src="{{ asset('public/images/category') }}/{{ $categorr->thumb }}" alt="{{ $categorr->title }}">
                                                @else
                                                <img class="media-object img-fluid" src="{{ asset('public/images') }}/notfind.png" alt="{{ $categorr->title }}">
                                                @endif
                                            </a>
                                        </div>
                                        <a href="{{ url('category') }}/{{ $categorr->slug }}">
