...
{{--                                        <label for="">Phone Number*</label>--}}
                                        <input type="number" class="form-control" name="phone" required placeholder="Please Enter Your Phone">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <div class="social-login">
                                        ...
                                        <a href="{{ route('login') }}" class="email"><i class="fas fa-envelope text-white"></i>Login with Email</a>
