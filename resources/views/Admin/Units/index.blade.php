            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Unit
                        <a href="{{ route('madmin.units.create') }}" class="btn btn-primary">Unit Add</a>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($units as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                    <a href="{{route('madmin.units.edit',$value->id)}}" class="btn btn-success m-1"><i class="fa fa-pen"></i> </a>
