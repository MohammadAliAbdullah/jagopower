    ...
    <table id="items">
        ...
        @foreach($orders as $order)
            <tr class="item-row">
                ...
                <td class="description">
                    <img src="{{ asset('public/images/product') }}/{{ $order->product->thumb }}" alt="" width="60">
                </td>
                <td align="right">
                    {{ $order->qty }}
                </td>
        ...
        <tr>
            <td class="blank"> </td>
            <td colspan="3" class="total-line">Discount (<?php //$value->discount;?> Tk):</td>
            <td class="total-value">
                <div id="subtotal">
        ...
        <tr>
            <td class="blank"> </td>
            <td colspan="3" class="total-line">VAT (0 %):</td>
            <td class="total-value">
                <div id="subtotal">
                    @if($data->vat !=NULL)
                        {{ $data->vat }} Tk
        ...
        <tr>
            <td class="blank"> </td>
            <td colspan="3" class="total-line">Delivary Charge:</td>
            <td class="total-value">
        ...
        <tr>
            ...
            <td colspan="3" class="total-line balance">Total Invoice:</td>
