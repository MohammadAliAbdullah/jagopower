...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Category
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('madmin.regular.index') }}" class="btn btn-success">Regular Category</a>
                            <a href="{{ route('madmin.spacial.index') }}" class="btn btn-warning">Spacial Category</a>
                        </div>
                    <!-- /.card-header -->
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($categories as $value)
                                    <tr>
                                        ...
                                        <td>
                                            @if($value->thumb!=NULL)
                                            <img src="{{ asset('public/images/category/'.$value->thumb) }}" width="80" height="60">
                                            @else
                                        ...
                                        <td>
                                            <div class="row">
                                                    <a href="{{route('madmin.categories.edit',$value->id)}}" class="btn btn-success m-1"><i class="fa fa-pen"></i> </a>
