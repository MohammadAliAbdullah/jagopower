...
{{--                    <br>--}}
                    ...
                    <b>Email:</b> {{ $data->customer->email }}<br><br>
                    ...
                    <b>Address: </b>{{ $ship['address'] }},<br>
                    <b>City: </b>{{ $ship['city'] }},<br>
                    <b>Area: </b> {{ $ship['area'] }}
                </td>
{{--                <td>--}}
...
{{--            </tr>--}}
            <tr>
                ...
                <td class="meta-head">Order Status</td>
                <td>
            ...
            <tr>
                ...
                <th class="meta-head">Total Bill</th>
                <td>
                    <div class="due">
                        {{ $data->total }} Tk
                    </div>
    ...
    <table id="items">
        ...
        <tr>
            <td colspan="2" class="blank"> </td>
            <td colspan="1" class="total-line">Discount (<?php //$value->discount;?> Tk):</td>
            <td class="total-value">
                <div id="subtotal">
...
{{--        </tr>--}}
        ...
        <tr>
            ...
            <td colspan="1" class="total-line balance">Total Invoice:</td>
